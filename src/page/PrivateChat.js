...
// import privatechatphonebgimg from "../assets/images/privatephoneimg.jpeg";

const PrivateChat = () => {
  return (
    <div className="flex w-full min-h-screen relative overflow-hidden background_privatechat_lap">
        ...
        <div className="flex w-4/5 mt-[128px]">
          <div className="flex w-full pl-4">
            <div className="w-full">
              ...
              <div className="flex w-full  font-serif text-left text-white text-[14px] sm:text-[18px] ">
                IN THIS SECTION YOU WILL BE ABLE TO ENTER PRIVATE CHATS AND TALK ABOUT SPECIFIC TOPICS TO PARTICIPATE. 
              </div>
              <div className="flex w-full font-serif text-left text-white text-[14px] sm:text-[18px] mb-5">
              ...
              <div className="flex w-full text-left text-red-500 text-[14px] sm:text-[18px]  mb-16">
